...
page = st.sidebar.radio("Select a page:", ["Home", "About", "Data Info", "Database Stats"])
...
if page == "Home":
    ...
    5. Log predictions to Snowflake for analytics
    
    #### Technologies Used:
    - **Streamlit**: Web application framework
    - **Snowflake**: Cloud data platform for storage and analytics
...
st.markdown("---")
st.markdown(
    "<div style='text-align: center'><p>Crop Recommendation System | Powered by Machine Learning & Snowflake</p></div>",
